...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        config.whatsapp_numero_1 = "0194140535"
        config.whatsapp_numero_2 = "0163404995"
        ...
        Programme.objects.update_or_create(
            ...
            defaults=dict(
                ...
                prix_fcfa=35000,
                prix_note="Peut aussi être inclus dans l'abonnement Premium — contactez-nous pour les modalités.",
                est_phare=True,
                actif=True,
                ordre_affichage=1,
            ),
